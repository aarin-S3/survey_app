               ...
               <div class="q-col-gutter-sm">
                  <div class="col-12 col-md-6">
                     ...
                     <div class="text-subtitle2 q-mb-sm" :class="subtitleClass">
                        Substation Details: <b>Heading</b>
                     </div>
                     ...
                     <div class="items-start q-mb-xs">
                        ...
                        <div :class="responsiveInputClass">
                        <q-select dense outlined emit-value map-options
                           v-model="form.relayPlacement"
                           :options="relayPlacements"
                           :class="inputClass" />
                        </div>
                     </div>
                     ...
                     <!-- 66 kV BAYS -->
                     <!-- ========================= -->
                     <div v-if="form.voltageLevel === '66'" class="q-mb-md">
                     ...
                     <!-- 33 kV BAYS -->
                     <!-- ========================= -->
                    <div v-if="form.voltageLevel === '33'" class="q-mb-md">

                        <div class="items-center q-mb-xs" v-for="(field, key) in [
                     ...
                     <!-- 11 kV BAYS -->
                     <!-- ========================= -->
                     <div v-if="form.voltageLevel === '11'" class="q-mb-md">
                     ...
                     <div class="items-center q-mb-xs">
                        ...
                        <div class="col-9">
                           <q-input
                              dense
                              outlined
                              placeholder="H × W × D (in mm)"
                              v-model="form.rtuPanelSize"
                              :class="inputClass"
                           />
                        </div>
                        </div>
                        ...
                        <div class="col-9">
                           <q-file
                              outlined
                              accept="image/*"
                              v-model="form.controlRoomPhoto"
                              label="Upload sketch / photo"
                              :class="inputClass"
                              clearable>
                        ...
                        <div class="col-9">
                           <q-input
                              ...
                              type="textarea"
                              autogrow
                              placeholder="Describe panel placement & RTU location"
                              v-model="form.controlRoomNotes"
                              :class="inputClass"
                           />
                        </div>
                        </div>
                     ...
                     <div class="items-center q-mb-xs">
                        ...
                        <div v-if="form.cableTrenchAvailable">
                        <div v-for="n in 4" :key="n" class="q-mb-sm">
                           ...
                           <q-option-group inline type="radio" :options="yesNoOptions" v-model="form.cableTrenches[n-1].marked" />
                        </div>
                        </div>
                        ...
                        <div class="col-9">
                           <q-option-group inline type="radio" :options="yesNoOptions" v-model="form.trenchExtensionRequired" />
                        </div>
                        </div>
